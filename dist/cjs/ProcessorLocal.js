...
const Processor = require("./Processor.js"),
  dataClean = require("./dataClean.js"),
  getEol = require("./getEol.js"),
  fileline = require("./fileline.js"),
  util = require("./util.js"),
  rowSplit = require("./rowSplit.js"),
  lineToJson = require("./lineToJson.js"),
  CSVError = require("./CSVError.js");
class ProcessorLocal extends Processor.Processor {
  flush() {
      ...
      return this.process(buf, true).then((res) => {
        if (this.runtime.csvLineBuffer && this.runtime.csvLineBuffer.length > 0) {
          return Promise.reject(
            CSVError.default.unclosed_quote(
  ...
  filterHeader() {
    ...
    if (this.runtime.headers) {
      ...
      this.runtime.headers = util.filterArray(
        this.runtime.headers,
        this.runtime.selectedColumns
      );
    }
